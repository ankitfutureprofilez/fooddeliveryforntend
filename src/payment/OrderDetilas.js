    ...
    <>
      <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        ...
        <div className="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
              ...
              <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6">
                ...
                {record && record.order_status == "delivered" ? (
                  <p className="text-green-500 text-base">
                    Order has been delivred at {record && record.deliveredAt}.{" "}
                  </p>
                ) : (
                  ""
                )}
          ...
          <div className="w-full xl:w-96 flex justify-between items-center md:items-start px-4 py-6 md:p-6 xl:p-8 flex-col bg-gray-50">
